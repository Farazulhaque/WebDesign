function calculate() {
  document.getElementsByClassName("output").disabled = false;
  cost1 =
    parseFloat(document.getElementById("items1").value) *
    Number(document.getElementById("quantity1").value);
  cost2 =
    parseFloat(document.getElementById("items2").value) *
    Number(document.getElementById("quantity2").value);
  cost3 =
    parseFloat(document.getElementById("items3").value) *
    Number(document.getElementById("quantity3").value);
  cost4 =
    parseFloat(document.getElementById("items4").value) *
